...
import { faFacebookF, faInstagram, faTwitter, faGithub, faWhatsapp} from '@fortawesome/free-brands-svg-icons';
      ...
      <div class="menu2">
       ...
       <div class="container">
           ...
           <div class="row">
             <div class="social-interest-btn desktop">
               <div class="hts-whatsapp-top-block">
                 <div >
                  ...
                  <a class="whatsapp" href="https://wa.me/01740369154" ><span class="whatsapp-icon"> <FontAwesomeIcon icon={faWhatsapp} /></span> 01740369154</a>
                 </div>
             ...
             <div class="hts-contact-top-block">
               <div>
                 ...
                 <a class="missed" href="tel:+01740369154"  title="For contacting customer service, please give a missed call and we will call you back soon (9am to 6pm)" ><span class="miss-call">Missed Call <FontAwesomeIcon icon={faPhone} /></span>  01740369154</a>
               </div>
        ...
        <div class="row ">
          ...
          {/* <a href="">
          <span>
          <img class="finder" src={img6} alt="home" />
          </span>
          <p class="home-name">Home Tuition Finder</p>
        ...
        <nav className="navbar">
          <ul>
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    {/* <a href="Sirajganj">Sirajganj</a> */}
                
              <a class="dropdown-item" href="Sirajganj">Sirajganj </a>
              <a class="dropdown-item" href="Rajshahi">Rajshahi </a>
              <a class="dropdown-item" href="Chittagong">Chittagong </a>
              <a class="dropdown-item" href="Dinajpur">Dinajpur</a>
              <a class="dropdown-item" href="Rangpur">Rangpur</a>
              <a class="dropdown-item" href="Pabna">Pabna</a>
